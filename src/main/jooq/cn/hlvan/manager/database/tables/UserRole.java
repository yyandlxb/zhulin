...
public class UserRole extends TableImpl<UserRoleRecord> {
    ...
    private static final long serialVersionUID = 1700054608;
     ...
     */
    public final TableField<UserRoleRecord, Timestamp> CREATE_AT = createField("create_at", org.jooq.impl.SQLDataType.TIMESTAMP.defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");
