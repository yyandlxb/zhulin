...
public class OrderRecord extends UpdatableRecordImpl<OrderRecord> implements Record21<Integer, String, Byte, Byte, Integer, Integer, BigDecimal, BigDecimal, String, String, Timestamp, Timestamp, String, Double, Integer, Byte, Timestamp, String, Integer, Integer, Integer> {

    private static final long serialVersionUID = -1404283535;
    ...
    /**
     * Setter for <code>zhulin.order.order_status</code>. 0: 待审核  1：待接单 2：已接单 3：待点评 4：商家已完成（已打款）5：取消 6：关闭 7：管理员已完成（已打款）
     */
    ...
    /**
     * Getter for <code>zhulin.order.order_status</code>. 0: 待审核  1：待接单 2：已接单 3：待点评 4：商家已完成（已打款）5：取消 6：关闭 7：管理员已完成（已打款）
     */
     ...
     */
    @Override
    public Row21<Integer, String, Byte, Byte, Integer, Integer, BigDecimal, BigDecimal, String, String, Timestamp, Timestamp, String, Double, Integer, Byte, Timestamp, String, Integer, Integer, Integer> fieldsRow() {
     ...
     */
    @Override
    public Row21<Integer, String, Byte, Byte, Integer, Integer, BigDecimal, BigDecimal, String, String, Timestamp, Timestamp, String, Double, Integer, Byte, Timestamp, String, Integer, Integer, Integer> valuesRow() {
