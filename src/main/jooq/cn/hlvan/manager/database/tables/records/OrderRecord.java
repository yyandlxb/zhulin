...
public class OrderRecord extends UpdatableRecordImpl<OrderRecord> implements Record21<Integer, String, String, String, Integer, Integer, BigDecimal, BigDecimal, String, String, Timestamp, Timestamp, String, Double, Integer, Byte, Timestamp, String, Integer, Integer, Integer> {

    private static final long serialVersionUID = -1793218511;
    ...
    /**
     * Setter for <code>zhulin.order.order_status</code>. 1：待接单 2：已接单 3：待审核 4：待点评 5：商家已完成（已打款）6：取消 7：关闭 8：管理员已完成（已打款）
     */
    public OrderRecord setOrderStatus(String value) {
        set(2, value);
        return this;
    }

    /**
     * Getter for <code>zhulin.order.order_status</code>. 1：待接单 2：已接单 3：待审核 4：待点评 5：商家已完成（已打款）6：取消 7：关闭 8：管理员已完成（已打款）
     */
     ...
     */
    public OrderRecord setPayType(String value) {
        set(3, value);
        return this;
    }
     ...
     */
    public OrderRecord setWordCount(Integer value) {
        set(19, value);
        return this;
    }
    ...
    /**
     * Setter for <code>zhulin.order.open_user</code>. 指定用户id
     */
    public OrderRecord setOpenUser(Integer value) {
        set(20, value);
        return this;
    }

    /**
     * Getter for <code>zhulin.order.open_user</code>. 指定用户id
     */
     ...
     */
    @Override
    public Row21<Integer, String, String, String, Integer, Integer, BigDecimal, BigDecimal, String, String, Timestamp, Timestamp, String, Double, Integer, Byte, Timestamp, String, Integer, Integer, Integer> fieldsRow() {
     ...
     */
    @Override
    public Row21<Integer, String, String, String, Integer, Integer, BigDecimal, BigDecimal, String, String, Timestamp, Timestamp, String, Double, Integer, Byte, Timestamp, String, Integer, Integer, Integer> valuesRow() {
     ...
     */
    @Override
    public OrderRecord value20(Integer value) {
        setWordCount(value);
        return this;
    }
     ...
     */
    @Override
    public OrderRecord value21(Integer value) {
        setOpenUser(value);
        return this;
    }
     ...
     */
    @Override
    public OrderRecord values(Integer value1, String value2, String value3, String value4, Integer value5, Integer value6, BigDecimal value7, BigDecimal value8, String value9, String value10, Timestamp value11, Timestamp value12, String value13, Double value14, Integer value15, Byte value16, Timestamp value17, String value18, Integer value19, Integer value20, Integer value21) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
