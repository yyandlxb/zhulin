...
public class Order extends TableImpl<OrderRecord> {
    ...
    private static final long serialVersionUID = -1720503563;
     ...
     */
    public final TableField<OrderRecord, Byte> PAY_TYPE = createField("pay_type", org.jooq.impl.SQLDataType.TINYINT, this, "1、微信 2、支付宝 3、银联 4、余额 5、现金 6、chinaPay");
