...
public class UserPermission extends TableImpl<UserPermissionRecord> {
    ...
    private static final long serialVersionUID = 716642303;
     ...
     */
    public final TableField<UserPermissionRecord, Timestamp> CREATED_AT = createField("created_at", org.jooq.impl.SQLDataType.TIMESTAMP.defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");
